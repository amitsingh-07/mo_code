...
export const environment: IEnvironment = {
  ...
  myInfoCallbackBaseUrl: 'https://newmouat1.ntucbfa.com/app/sginfo',
  ...
  configJsonUrl: 'https://mo-static-assets-nonprod.s3.ap-southeast-1.amazonaws.com/promo/newmo/app-config.json',
  hsPortalId: '6411917',
